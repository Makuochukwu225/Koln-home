...
export default function Home() {
  ...
  // Default URL driven by environment variable NEXT_PUBLIC_WS_URL
  ...
  // Read environment variable on mount
  useEffect(() => {
    setMounted(true);
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-4 sm:p-8 font-sans antialiased select-none">
      <div className="max-w-xl w-full space-y-5">
        ...
        {/* Backend Socket Endpoint Bar (Driven by NEXT_PUBLIC_WS_URL) */}
        <section className="bg-slate-900/40 border border-slate-800/80 p-3 rounded-xl flex items-center gap-3">
          ...
          <div className="flex-1 flex items-center gap-2">
            <input
              ...
              placeholder="wss://koln-api.jaxlabs.site"
            ...
            {process.env.NEXT_PUBLIC_WS_URL && (
              <span className="text-[10px] bg-slate-800 text-sky-400 border border-slate-700 px-2 py-0.5 rounded font-mono hidden sm:inline-block">
                env
              </span>
            )}
          </div>
